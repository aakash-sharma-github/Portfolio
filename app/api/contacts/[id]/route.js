...
// PUT handler to update a contact message
export async function PUT(request, { params }) {
    try {
        ...
        if (data.reply) {
            ...
            existingContact.status = 'replied';
        }

        // Update other fields if provided
        if (data.status) {
            existingContact.status = data.status;
        }
        if (data.priority) {
            existingContact.priority = data.priority;
        }
        if (data.notes) {
            existingContact.notes = data.notes;
        }
